        ...
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 md:gap-6">
          <div className="flex-1 min-w-0 md:pr-8">
            <div className="flex items-center gap-3 md:gap-4 mb-2 md:mb-3">
              <Dna className="w-6 h-6 md:w-8 md:h-8 text-blue-500 shrink-0" />
              <CopyableText text={skill.title} variant="text" className="text-xl md:text-3xl font-bold text-white tracking-tight leading-tight" />
            </div>
