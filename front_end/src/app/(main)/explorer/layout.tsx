      ...
      <div className="relative bg-[#09090b] border border-zinc-800 rounded-xl shadow-2xl w-full max-w-md overflow-hidden">
        ...
        <div className="bg-zinc-900/50 px-6 py-4 flex flex-wrap items-center justify-end gap-3 border-t border-zinc-800/50">
          <button
            onClick={onClose}
            disabled={isLoading}
            className="shrink-0 whitespace-nowrap px-4 py-2 rounded-lg text-sm text-zinc-400 hover:text-zinc-200 hover:bg-zinc-800 transition-colors disabled:opacity-50"
          >
