...
const translations = {
  ...
  "auth.loginTab": { zh: "登录", en: "Login" },
  "auth.registerTab": { zh: "注册", en: "Register" },
  "auth.orUsePassword": { zh: "或使用密码登录", en: "or sign in with password" },
  "auth.username": { zh: "用户名", en: "Username" },
  "auth.password": { zh: "密码", en: "Password" },
  "auth.confirmPassword": { zh: "确认密码", en: "Confirm Password" },
  "auth.inviteCode": { zh: "邀请码", en: "Invite Code" },
  "auth.register": { zh: "注册", en: "Register" },
  "auth.loginWithPassword": { zh: "登录", en: "Login" },
