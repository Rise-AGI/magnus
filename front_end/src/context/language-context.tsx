...
const translations = {
  ...
  "files.sharedManageTitle": { zh: "管理共享文件夹", en: "Manage Shared Folder" },
  "files.sharedManageHint": { zh: "输入 token 查看、浏览或管理共享文件夹。", en: "Enter token to view, browse, or manage a shared folder." },
  "files.sharedTokenLabel": { zh: "Token", en: "Token" },
  "files.sharedViewButton": { zh: "查看", en: "View" },
  "files.sharedNotFound": { zh: "未找到该 Token", en: "Token not found" },
  "files.sharedArchived": { zh: "已归档", en: "Archived" },
  "files.sharedActive": { zh: "活跃", en: "Active" },
  "files.sharedCreatedBy": { zh: "创建者", en: "Created by" },
  "files.sharedCreatedAt": { zh: "创建时间", en: "Created at" },
  "files.sharedExpiresAt": { zh: "过期时间", en: "Expires at" },
  "files.sharedActualSize": { zh: "实际大小", en: "Actual size" },
  "files.sharedFiles": { zh: "文件列表", en: "Files" },
  "files.sharedNoFiles": { zh: "文件夹为空", en: "Folder is empty" },
  "files.sharedDownloadFile": { zh: "下载", en: "Download" },
  "files.sharedUpdateTitle": { zh: "更新属性", en: "Update Properties" },
  "files.sharedExtendDays": { zh: "延长天数", en: "Extend Days" },
  "files.sharedNewExpectedSize": { zh: "新的预期大小（GB）", en: "New Expected Size (GB)" },
  "files.sharedUpdateButton": { zh: "更新", en: "Update" },
  "files.sharedUpdateSuccess": { zh: "更新成功", en: "Updated successfully" },
  "files.sharedUpdateFailed": { zh: "更新失败", en: "Update failed" },
  "files.sharedRestoreTitle": { zh: "恢复归档", en: "Restore Archive" },
  "files.sharedRestoreHint": { zh: "该文件夹已被归档。您可以恢复它并设置新的过期时间。", en: "This folder has been archived. You can restore it with a new expiration." },
  "files.sharedRestoreDays": { zh: "恢复后过期天数", en: "Days until expiration" },
  "files.sharedRestoreButton": { zh: "恢复", en: "Restore" },
  "files.sharedRestoreSuccess": { zh: "恢复成功", en: "Restored successfully" },
  "files.sharedRestoreFailed": { zh: "恢复失败", en: "Restore failed" },
  "files.sharedNoPermission": { zh: "无权限操作", en: "Permission denied" },
  "files.sharedBackToRoot": { zh: "返回根目录", en: "Back to root" },
  "files.sharedCurrentPath": { zh: "当前路径", en: "Current path" },
  "files.sharedBrowse": { zh: "浏览", en: "Browse" },
