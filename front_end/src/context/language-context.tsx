...
def blueprint(
  ...
  "people.recruit.credentialsSaveWarning": { zh: "请妥善保存 App Secret，此后将无法再次查看完整值。", en: "Please save the App Secret securely. You will not be able to view the full value again." },
  "people.recruit.connector": { zh: "连接器类型", en: "Connector" },
  "people.recruit.connectorGeneral": { zh: "通用", en: "General" },
  ...
  "people.drawer.refreshCredentialsDesc": { zh: "刷新后旧的 App Secret 将立即失效，所有使用旧凭证的 Bot 连接将断开。", en: "After refresh, the old App Secret will be immediately invalidated and all Bot connections using old credentials will be disconnected." },
