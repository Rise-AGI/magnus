# back_end/server/_file_custody_manager/_word_list.py
"""Human-friendly download token components: <prime>-<word>-<word>-<word>。

数据与生成逻辑分离：素数表 + 单词表在这里，token 拼装在 _manager.py。
"""
