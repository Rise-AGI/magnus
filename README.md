...
│   │   │   ├── services/                                  # 弹性服务管理页面
│   │   │   │   └── page.tsx
│   │   │   ├── enchant/                                   # Enchant 智能对话
│   │   │   │   ├── layout.tsx                             # Enchant 布局（会话列表）
│   │   │   │   ├── page.tsx                               # Enchant 首页
│   │   │   │   └── [sessionId]/                           # 会话详情页面
│   │   │   │       └── page.tsx
│   │   │   ├── tools/                                     # 工具页面
...
Enchant 是 Magnus 平台内置的 AI 对话助手，支持多模态输入和流式响应。
...
4. **Enchant 智能对话**: 平台内置 AI 对话助手，支持多模态输入、流式响应、思考过程可视化、后台持久化与智能标题生成。
